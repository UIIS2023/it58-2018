...
public class DlgModifyHexagon extends JDialog {
	...
	public DlgModifyHexagon(HexagonAdapter hexagon) {
		...
		txtCenterX.setText("" + hexagon.getHexagon().getX());
		...
		txtCenterY.setText("" + hexagon.getHexagon().getY());
		...
		btnLineColor.setBackground(hexagon.getHexagon().getBorderColor());
		...
		btnFillColor.setBackground(hexagon.getHexagon().getAreaColor());
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							//	Hexagon h = new Hexagon(centerX, centerY, radius);
								
							//	h.setBorderColor(btnLineColor.getBackground());
						//		h.setAreaColor(btnFillColor.getBackground());
								
						//		hexagon.setHexagon(h);
								correct = true;
								dispose();
							}
